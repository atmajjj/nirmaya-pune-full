...
import { Users, BarChart3, FileCheck, Database, MessageCircle, Settings, UserPlus, Mail } from "lucide-react";
...
const navItems = [
  ...
  { title: "Invitation Management", path: "/admin/invitation-management", icon: <Mail className="w-5 h-5" /> },
