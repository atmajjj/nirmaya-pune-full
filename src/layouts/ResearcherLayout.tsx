...
import { BarChart3, Database, BookOpen, Map, Target, Settings } from "lucide-react";
...
const navItems = [
  ...
  { title: "Research Workspace", path: "/researcher/workspace", icon: <Target className="w-5 h-5" /> },
