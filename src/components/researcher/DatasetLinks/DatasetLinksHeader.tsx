    ...
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-100 via-slate-50 to-blue-50 border border-slate-200/80 shadow-lg mb-6">
      ...
      <div className="relative flex items-center justify-between p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-800 mb-1">Dataset Links</h1>
            <p className="text-sm text-slate-600">Access comprehensive water quality datasets and resources</p>
          </div>
        </div>
