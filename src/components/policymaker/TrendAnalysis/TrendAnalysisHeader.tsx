...
interface TrendAnalysisHeaderProps {
  isGeneratingReport: boolean;
  onGenerateReport: () => void;
}

const TrendAnalysisHeader = ({ isGeneratingReport, onGenerateReport }: TrendAnalysisHeaderProps) => {
return (
...
export default TrendAnalysisHeader;
